...
var input = function(type){
    return function(opt){
        ...
        w.toHTML = function(name, f){
            var f = f || {};
            var html = '<div class = "controls"><input';
            html += ' type="' + type + '"';
...
exports.select = function(opt){
    ...
    w.toHTML = function(name, f){
        var f = f || {};
        var html = '<div class = "controls"><select' + attrs({
            name: name,
            id: f.id,
            classes: w.classes
        }) + '>';
...
exports.textarea = function(opt){
    ...
    w.toHTML = function(name, f){
        var f = f || {};
        var html = '<div class = "controls"><textarea' + attrs({
            name: name,
            id: f.id,
            classes: w.classes
        });
...
exports.multipleCheckbox = function(opt){
    ...
    w.toHTML = function(name, f){
        ...
        return Object.keys(f.choices).reduce(function(html, k){
            // input element
            html += '<div class = "controls"><input type="checkbox"';
            html += ' name="' + name + '"';
...
exports.multipleRadio = function(opt){
    ...
    w.toHTML = function(name, f){
        ...
        return Object.keys(f.choices).reduce(function(html, k){
            // input element
            html += '<div class = "controls"><input type="radio"';
            html += ' name="' + name + '"';
...
exports.multipleSelect = function(opt){
    ...
    w.toHTML = function(name, f){
        var f = f || {};
        var html = '<div class = "controls"><select multiple="mulitple"' + attrs({
            name: name,
            id: f.id,
            classes: w.classes
        }) + '>';
