var wrapWith = function(tag){
    return function(name, field){
		...
		else if(field.widget.type == 'checkbox'){
			html+="<div class = 'control-group'><div class = 'controls'><label class = 'checkbox inline'> "+ field.widget.toHTML(name, field) + field.labelText(name) +"</div></div>"
		}
        else {
