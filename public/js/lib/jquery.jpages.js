...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype.writeNav = function () {
        ...
        for ( ; i <= this._numPages; i++ ) {
            ...
            if ( i > this.options.startRange && i <= this._numPages - this.options.endRange ) {
                navhtml += "<li class = 'jp-hidden'><a href='#'>";
            } else {
                navhtml += "<li><a href = 'page/"+ i +"/'>";
            }
    ...
    Plugin.prototype.writeBtn = function ( which ) {
        ...
        return this.options[which] !== false && !$( this[ "_" + which ] ).length ? 
            "<li class='" + which + "'><a href='#'>" + this.options[which] + "</a></li>" : "";
    ...
    Plugin.prototype.cacheNavElements = function ( holder, index ) {
        ...
        this._nav[index].first = this._first.length ? this._first : this._nav[index].holder.find("li.first");
        this._nav[index].previous = this._previous.length ? this._previous : this._nav[index].holder.find("li.previous");
        this._nav[index].next = this._next.length ? this._next : this._nav[index].holder.find("li.next");
        this._nav[index].last = this._last.length ? this._last : this._nav[index].holder.find("li.last");

        this._nav[index].fstBreak = this._nav[index].holder.find("span:first");
        this._nav[index].lstBreak = this._nav[index].holder.find("span:last");

        this._nav[index].pages = this._nav[index].holder.find("li").not(".first, .previous, .next, .last");
    ...
    Plugin.prototype.bindNavHandlers = function ( index ) {
        ...
        // default nav
        nav.holder.bind( "click", this.bind( function( evt ) {
        ...
        if ( this._previous.length ) {
            this._previous.bind( "click", this.bind( function() {
        ...
        if ( this._next.length ) {
            this._next.bind( "click", this.bind( function() {
                var newPage = this._currentPageNum + 1;
                if ( this.validNewPage( newPage ) ) {
                    this._clicked = true;
                    this.paginate( newPage, true );
    ...
    Plugin.prototype.destroy = function () {
        ...
        this._holder.unbind("click").empty();
    };
